...
public class ScoreDatosGeneralesApi {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public ScoreDatosGeneralesApi() {
        this(Configuration.getDefaultApiClient());
    }

    public ScoreDatosGeneralesApi(ApiClient apiClient) {
     ...
     */
    public okhttp3.Call Call(@javax.annotation.Nonnull String xSignature, @javax.annotation.Nonnull String xApiKey, @javax.annotation.Nonnull String username, @javax.annotation.Nonnull String password, @javax.annotation.Nonnull RequestScoreDG scoreDG, final ApiCallback _callback) throws ApiException {
        ...
        Object localVarPostBody = scoreDG;
    ...
    private okhttp3.Call ValidateBeforeCall(@javax.annotation.Nonnull String xSignature, @javax.annotation.Nonnull String xApiKey, @javax.annotation.Nonnull String username, @javax.annotation.Nonnull String password, @javax.annotation.Nonnull RequestScoreDG scoreDG, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'xSignature' is set
        if (xSignature == null) {
            throw new ApiException("Missing the required parameter 'xSignature' when calling (Async)");
        }

        // verify the required parameter 'xApiKey' is set
        if (xApiKey == null) {
            throw new ApiException("Missing the required parameter 'xApiKey' when calling (Async)");
        }

        // verify the required parameter 'username' is set
        if (username == null) {
            throw new ApiException("Missing the required parameter 'username' when calling (Async)");
        }

        // verify the required parameter 'password' is set
        if (password == null) {
            throw new ApiException("Missing the required parameter 'password' when calling (Async)");
        }

        // verify the required parameter 'scoreDG' is set
        if (scoreDG == null) {
            throw new ApiException("Missing the required parameter 'scoreDG' when calling (Async)");
        }

        return Call(xSignature, xApiKey, username, password, scoreDG, _callback);
     ...
     */
    public ApiResponse<ResponseScore> WithHttpInfo(@javax.annotation.Nonnull String xSignature, @javax.annotation.Nonnull String xApiKey, @javax.annotation.Nonnull String username, @javax.annotation.Nonnull String password, @javax.annotation.Nonnull RequestScoreDG scoreDG) throws ApiException {
        okhttp3.Call localVarCall = ValidateBeforeCall(xSignature, xApiKey, username, password, scoreDG, null);
     ...
     */
    public okhttp3.Call Async(@javax.annotation.Nonnull String xSignature, @javax.annotation.Nonnull String xApiKey, @javax.annotation.Nonnull String username, @javax.annotation.Nonnull String password, @javax.annotation.Nonnull RequestScoreDG scoreDG, final ApiCallback<ResponseScore> _callback) throws ApiException {

        okhttp3.Call localVarCall = ValidateBeforeCall(xSignature, xApiKey, username, password, scoreDG, _callback);
        Type localVarReturnType = new TypeToken<ResponseScore>(){}.getType();
