...
public class Error {
  ...
  public Error codigo(@javax.annotation.Nullable String codigo) {
    this.codigo = codigo;
    return this;
  }
  ...
  public Error mensaje(@javax.annotation.Nullable String mensaje) {
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("codigo", "mensaje"));
