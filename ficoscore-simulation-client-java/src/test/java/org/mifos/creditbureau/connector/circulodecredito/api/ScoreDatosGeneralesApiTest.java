...
/**
 * API tests for ScoreDatosGeneralesApi
 */
@Disabled
public class ScoreDatosGeneralesApiTest {

    private final ScoreDatosGeneralesApi api = new ScoreDatosGeneralesApi();
    ...
    public void Test() throws ApiException {
        ...
        RequestScoreDG scoreDG = null;
        ResponseScore response = api.(xSignature, xApiKey, username, password, scoreDG);
